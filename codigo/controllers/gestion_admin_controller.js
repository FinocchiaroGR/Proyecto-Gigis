...
exports.get = ((request,response,next) => {
    ...
    const tienePermiso = permiso.includes(1) || permiso.includes(2) || permiso.includes(3) || permiso.includes(4) || permiso.includes(6) || permiso.includes(9) || permiso.includes(10) || permiso.includes(11) || permiso.includes(12) || permiso.includes(13) || permiso.includes(16) || permiso.includes(17);
    if(tienePermiso){ 
